...
export default function FirefighterProfile({ firefighterId, onNavigate, onUpdateUser }) {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/firefighter/${firefighterId}`)
      .then(r => r.json())
      .then(data => {
  ...
  const handleUpdate = async () => {
    setSaving(true);
    try {
      await fetch(`${process.env.REACT_APP_API_URL}/api/firefighter/${firefighterId}`, {
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await fetch(`${process.env.REACT_APP_API_URL}/api/firefighter/${firefighterId}`, { method: 'DELETE' });
      onNavigate?.('home');
